...
#[derive(Clone, Debug)]
pub struct ResetWritePointerCommand<'a> {
    interface: &'a Scsi,
    timeout: Option<std::time::Duration>,
    command_buffer: CommandBuffer,
}

impl<'a> ResetWritePointerCommand<'a> {
...
impl Scsi {
    pub fn reset_write_pointer(&self) -> ResetWritePointerCommand<'_> {
        ResetWritePointerCommand::new(self)
    }
}

const OPERATION_CODE: u8 = 0x94;
const SERVICE_ACTION: u8 = 0x04;
