...
#[derive(Clone, Debug)]
pub struct FinishZoneCommand<'a> {
    interface: &'a Scsi,
    timeout: Option<std::time::Duration>,
    command_buffer: CommandBuffer,
}

impl<'a> FinishZoneCommand<'a> {
...
impl Scsi {
    pub fn finish_zone(&self) -> FinishZoneCommand<'_> {
        FinishZoneCommand::new(self)
    }
}

const OPERATION_CODE: u8 = 0x94;
const SERVICE_ACTION: u8 = 0x02;
